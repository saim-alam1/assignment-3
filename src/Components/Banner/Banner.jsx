    ...
    <section className="max-w-360 mx-auto">
      ...
      <div className="flex items-center justify-center gap-4">
        <Link
          ...
          target="_blank"
          className="btn h-auto hover:shadow-lg transition-all duration-300 bg-transparent ease-in-out py-2 px-6"
        >
        ...
        <Link
          ...
          target="_blank"
          className="btn h-auto hover:shadow-lg transition-all duration-300 bg-transparent py-2 px-6 ease-in-out"
        >
